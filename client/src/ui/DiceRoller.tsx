...
export default function DiceRoller({ boardReady = true, onRollRevealed, onPresentationChange }: DiceRollerProps) {
  ...
  if (isWaitingForBoard) {
    return (
      <div className="dice-center-status [--game-chrome-primary:var(--color-brand-primary)] [--game-chrome-bg:color-mix(in_srgb,_var(--color-surface-raised)_92%,_transparent)] [--game-chrome-bg-strong:color-mix(in_srgb,_var(--color-surface-canvas)_97%,_transparent)] [--game-chrome-panel:rgba(19,_105,_132,_0.78)] [--game-chrome-border:var(--color-border-subtle)] [--game-chrome-gold:var(--color-status-warning)] [--game-chrome-gold-deep:#d89a08] [--game-chrome-text:var(--color-text-primary)] [--game-chrome-muted:var(--color-text-secondary)] [font-family:Inter,_ui-sans-serif,_system-ui,_-apple-system,_BlinkMacSystemFont,_'Segoe_UI',_sans-serif] [position:fixed] [inset:0] [z-index:50] [display:flex] [align-items:center] [justify-content:center] [padding:max(0.75rem,_env(safe-area-inset-top))_max(0.75rem,_env(safe-area-inset-right))_max(0.75rem,_env(safe-area-inset-bottom))_max(0.75rem,_env(safe-area-inset-left))] [pointer-events:none]">
  ...
  if (rolling) {
    return (
      <section className="dice-stage [--game-chrome-primary:var(--color-brand-primary)] [--game-chrome-bg:color-mix(in_srgb,_var(--color-surface-raised)_92%,_transparent)] [--game-chrome-bg-strong:color-mix(in_srgb,_var(--color-surface-canvas)_97%,_transparent)] [--game-chrome-panel:rgba(19,_105,_132,_0.78)] [--game-chrome-border:var(--color-border-subtle)] [--game-chrome-gold:var(--color-status-warning)] [--game-chrome-gold-deep:#d89a08] [--game-chrome-text:var(--color-text-primary)] [--game-chrome-muted:var(--color-text-secondary)] [font-family:Inter,_ui-sans-serif,_system-ui,_-apple-system,_BlinkMacSystemFont,_'Segoe_UI',_sans-serif] [position:fixed] [inset:0] [z-index:50] [display:flex] [align-items:center] [justify-content:center] [padding:max(0.75rem,_env(safe-area-inset-top))_max(0.75rem,_env(safe-area-inset-right))_max(0.75rem,_env(safe-area-inset-bottom))_max(0.75rem,_env(safe-area-inset-left))] [pointer-events:none]" aria-live="polite" aria-label="Xúc xắc đang xoay">
        <div className="dice-presentation [position:relative] [display:flex] [flex-direction:column] [align-items:center] [gap:0.8rem] animate-game-dice-arrive [&.is-result_.dice-aura [position:absolute] [inset:-3rem] [z-index:-1] [border-radius:999px] [background:rgba(75,_213,_255,_0.18)] [filter:blur(2.5rem)]]:[background:rgba(255,_220,_93,_0.2)] [&.is-result_.dice-pair [position:relative] [display:flex] [gap:0.8rem] [padding:1rem] [border:1px_solid_rgba(75,_213,_255,_0.24)] [border-radius:1.55rem] [background:radial-gradient(circle_at_50%_0,_rgba(75,_213,_255,_0.14),_transparent_55%),_rgba(3,_22,_33,_0.88)] [box-shadow:0_1.2rem_4rem_rgba(1,_15,_24,_0.54),_inset_0_1px_rgba(255,_255,_255,_0.1)] [backdrop-filter:blur(20px)] [@media(max-height:480px)_and_(orientation:landscape)]:[gap:0.68rem] [@media(max-height:480px)_and_(orientation:landscape)]:[padding:0.78rem] [@media(max-height:480px)_and_(orientation:landscape)]:[border-radius:1.25rem]]:[border-color:rgba(255,_220,_93,_0.28)] [@media(max-height:480px)_and_(orientation:landscape)]:[gap:0.65rem] motion-reduce:[animation:none] is-rolling">
  ...
  if (showResult) {
    ...
    return (
      <section className="dice-stage [--game-chrome-primary:var(--color-brand-primary)] [--game-chrome-bg:color-mix(in_srgb,_var(--color-surface-raised)_92%,_transparent)] [--game-chrome-bg-strong:color-mix(in_srgb,_var(--color-surface-canvas)_97%,_transparent)] [--game-chrome-panel:rgba(19,_105,_132,_0.78)] [--game-chrome-border:var(--color-border-subtle)] [--game-chrome-gold:var(--color-status-warning)] [--game-chrome-gold-deep:#d89a08] [--game-chrome-text:var(--color-text-primary)] [--game-chrome-muted:var(--color-text-secondary)] [font-family:Inter,_ui-sans-serif,_system-ui,_-apple-system,_BlinkMacSystemFont,_'Segoe_UI',_sans-serif] [position:fixed] [inset:0] [z-index:50] [display:flex] [align-items:center] [justify-content:center] [padding:max(0.75rem,_env(safe-area-inset-top))_max(0.75rem,_env(safe-area-inset-right))_max(0.75rem,_env(safe-area-inset-bottom))_max(0.75rem,_env(safe-area-inset-left))] [pointer-events:none]" aria-live="polite" aria-label={`Kết quả xúc xắc là ${total}`}>
        <div className="dice-presentation [position:relative] [display:flex] [flex-direction:column] [align-items:center] [gap:0.8rem] animate-game-dice-arrive [&.is-result_.dice-aura [position:absolute] [inset:-3rem] [z-index:-1] [border-radius:999px] [background:rgba(75,_213,_255,_0.18)] [filter:blur(2.5rem)]]:[background:rgba(255,_220,_93,_0.2)] [&.is-result_.dice-pair [position:relative] [display:flex] [gap:0.8rem] [padding:1rem] [border:1px_solid_rgba(75,_213,_255,_0.24)] [border-radius:1.55rem] [background:radial-gradient(circle_at_50%_0,_rgba(75,_213,_255,_0.14),_transparent_55%),_rgba(3,_22,_33,_0.88)] [box-shadow:0_1.2rem_4rem_rgba(1,_15,_24,_0.54),_inset_0_1px_rgba(255,_255,_255,_0.1)] [backdrop-filter:blur(20px)] [@media(max-height:480px)_and_(orientation:landscape)]:[gap:0.68rem] [@media(max-height:480px)_and_(orientation:landscape)]:[padding:0.78rem] [@media(max-height:480px)_and_(orientation:landscape)]:[border-radius:1.25rem]]:[border-color:rgba(255,_220,_93,_0.28)] [@media(max-height:480px)_and_(orientation:landscape)]:[gap:0.65rem] motion-reduce:[animation:none] is-result">
          <span className="dice-aura [position:absolute] [inset:-3rem] [z-index:-1] [border-radius:999px] [background:rgba(75,_213,_255,_0.18)] [filter:blur(2.5rem)]" aria-hidden="true" />
          <div className="dice-pair [position:relative] [display:flex] [gap:0.8rem] [padding:1rem] [border:1px_solid_rgba(75,_213,_255,_0.24)] [border-radius:1.55rem] [background:radial-gradient(circle_at_50%_0,_rgba(75,_213,_255,_0.14),_transparent_55%),_rgba(3,_22,_33,_0.88)] [box-shadow:0_1.2rem_4rem_rgba(1,_15,_24,_0.54),_inset_0_1px_rgba(255,_255,_255,_0.1)] [backdrop-filter:blur(20px)] [@media(max-height:480px)_and_(orientation:landscape)]:[gap:0.68rem] [@media(max-height:480px)_and_(orientation:landscape)]:[padding:0.78rem] [@media(max-height:480px)_and_(orientation:landscape)]:[border-radius:1.25rem]">
