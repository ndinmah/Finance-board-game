        ...
        >
          ...
          {(
            ...
            <div className="p-[0_1.6rem_1rem] bg-[#f0eadd] border-t border-[rgba(0,0,0,0.06)] flex flex-col items-center gap-3 shrink-0">
              {isMyTurn && isOwner && turnPhase === 'pay_debt' && (
                <button className="font-inter cursor-pointer touch-manipulation disabled:opacity-50 disabled:cursor-not-allowed btn-3d [background-color:var(--btn-color,_#0ea5e9)] [color:var(--btn-text,_white)] [border:none] [border-radius:2rem] [padding:var(--btn-pad,_0.8rem_1.8667rem)] [font-size:var(--btn-size,_1.0667rem)] [font-weight:800] [cursor:pointer] [display:inline-flex] [justify-content:center] [align-items:center] [gap:0.5333rem] [box-shadow:0_0.4rem_0_var(--btn-shadow,_#0284c7)] [transition:transform_0.1s,_box-shadow_0.1s,_filter_0.1s] [text-transform:uppercase] [letter-spacing:0.5px] [&:active:not(.disabled):not(:disabled)]:[transform:translateY(0.4rem)] [&:active:not(.disabled):not(:disabled)]:[box-shadow:0_0px_0_var(--btn-shadow,_#0284c7)] [&:hover:not(.disabled):not(:disabled)]:[filter:brightness(1.1)] [&.disabled]:![background-color:#94a3b8] disabled:![background-color:#94a3b8] [&.disabled]:![box-shadow:0_0.4rem_0_#64748b] disabled:![box-shadow:0_0.4rem_0_#64748b] [&.disabled]:![cursor:not-allowed] disabled:![cursor:not-allowed] [&.disabled]:![transform:translateY(0)] disabled:![transform:translateY(0)] [&.disabled]:![filter:none] disabled:![filter:none] [&.disabled]:![color:#e2e8f0] disabled:![color:#e2e8f0] btn-3d-red [--btn-color:#ef4444] [--btn-shadow:#b91c1c] text-[0.9333rem] px-8 py-2" onClick={handleSellForDebt}>
                  Bán để trả nợ ({formatMoneyFull(Math.floor(totalValue * 0.5))}$)
                </button>
              )}
              {turnPhase === 'airport_select' && isMyTurn && isValidAirportDestination && (
                <button className="font-inter cursor-pointer touch-manipulation disabled:opacity-50 disabled:cursor-not-allowed btn-3d [background-color:var(--btn-color,_#0ea5e9)] [color:var(--btn-text,_white)] [border:none] [border-radius:2rem] [padding:var(--btn-pad,_0.8rem_1.8667rem)] [font-size:var(--btn-size,_1.0667rem)] [font-weight:800] [cursor:pointer] [display:inline-flex] [justify-content:center] [align-items:center] [gap:0.5333rem] [box-shadow:0_0.4rem_0_var(--btn-shadow,_#0284c7)] [transition:transform_0.1s,_box-shadow_0.1s,_filter_0.1s] [text-transform:uppercase] [letter-spacing:0.5px] [&:active:not(.disabled):not(:disabled)]:[transform:translateY(0.4rem)] [&:active:not(.disabled):not(:disabled)]:[box-shadow:0_0px_0_var(--btn-shadow,_#0284c7)] [&:hover:not(.disabled):not(:disabled)]:[filter:brightness(1.1)] [&.disabled]:![background-color:#94a3b8] disabled:![background-color:#94a3b8] [&.disabled]:![box-shadow:0_0.4rem_0_#64748b] disabled:![box-shadow:0_0.4rem_0_#64748b] [&.disabled]:![cursor:not-allowed] disabled:![cursor:not-allowed] [&.disabled]:![transform:translateY(0)] disabled:![transform:translateY(0)] [&.disabled]:![filter:none] disabled:![filter:none] [&.disabled]:![color:#e2e8f0] disabled:![color:#e2e8f0] btn-primary [background-color:#0ea5e9] [color:white] [border:none] [border-radius:2rem] [padding:0.8rem_1.8667rem] [font-size:1.0667rem] [font-weight:800] [cursor:pointer] [display:inline-flex] [justify-content:center] [align-items:center] [gap:0.5333rem] [box-shadow:0_0.4rem_0_#0284c7] [transition:transform_0.1s,_box-shadow_0.1s,_filter_0.1s] [text-transform:uppercase] [letter-spacing:0.5px] [&:active:not(:disabled)]:[transform:translateY(0.4rem)] [&:active:not(:disabled)]:[box-shadow:0_0px_0_#0284c7] [&:hover:not(:disabled)]:[filter:brightness(1.1)] disabled:[background-color:#94a3b8] disabled:[box-shadow:0_0.4rem_0_#64748b] disabled:[cursor:not-allowed] disabled:[transform:translateY(0)] text-[0.9333rem] px-8 py-2" onClick={handleAirportSelect}>
                  ✈️ Bay đến đây!
                </button>
              )}
              {turnPhase === 'festival_select' && isMyTurn && isOwner && (
                <button className="font-inter cursor-pointer touch-manipulation disabled:opacity-50 disabled:cursor-not-allowed btn-3d [background-color:var(--btn-color,_#0ea5e9)] [color:var(--btn-text,_white)] [border:none] [border-radius:2rem] [padding:var(--btn-pad,_0.8rem_1.8667rem)] [font-size:var(--btn-size,_1.0667rem)] [font-weight:800] [cursor:pointer] [display:inline-flex] [justify-content:center] [align-items:center] [gap:0.5333rem] [box-shadow:0_0.4rem_0_var(--btn-shadow,_#0284c7)] [transition:transform_0.1s,_box-shadow_0.1s,_filter_0.1s] [text-transform:uppercase] [letter-spacing:0.5px] [&:active:not(.disabled):not(:disabled)]:[transform:translateY(0.4rem)] [&:active:not(.disabled):not(:disabled)]:[box-shadow:0_0px_0_var(--btn-shadow,_#0284c7)] [&:hover:not(.disabled):not(:disabled)]:[filter:brightness(1.1)] [&.disabled]:![background-color:#94a3b8] disabled:![background-color:#94a3b8] [&.disabled]:![box-shadow:0_0.4rem_0_#64748b] disabled:![box-shadow:0_0.4rem_0_#64748b] [&.disabled]:![cursor:not-allowed] disabled:![cursor:not-allowed] [&.disabled]:![transform:translateY(0)] disabled:![transform:translateY(0)] [&.disabled]:![filter:none] disabled:![filter:none] [&.disabled]:![color:#e2e8f0] disabled:![color:#e2e8f0] btn-3d-purple [--btn-color:#a855f7] [--btn-shadow:#7e22ce] text-[0.9333rem] px-8 py-2" onClick={handleFestivalSelect}>
                  🎉 Tổ chức Lễ Hội (50K)
                </button>
              )}
              ...
              {turnPhase === 'chance_shield_select' && isMyTurn && isOwner && (
                <button className="font-inter cursor-pointer touch-manipulation disabled:opacity-50 disabled:cursor-not-allowed btn-3d [background-color:var(--btn-color,_#0ea5e9)] [color:var(--btn-text,_white)] [border:none] [border-radius:2rem] [padding:var(--btn-pad,_0.8rem_1.8667rem)] [font-size:var(--btn-size,_1.0667rem)] [font-weight:800] [cursor:pointer] [display:inline-flex] [justify-content:center] [align-items:center] [gap:0.5333rem] [box-shadow:0_0.4rem_0_var(--btn-shadow,_#0284c7)] [transition:transform_0.1s,_box-shadow_0.1s,_filter_0.1s] [text-transform:uppercase] [letter-spacing:0.5px] [&:active:not(.disabled):not(:disabled)]:[transform:translateY(0.4rem)] [&:active:not(.disabled):not(:disabled)]:[box-shadow:0_0px_0_var(--btn-shadow,_#0284c7)] [&:hover:not(.disabled):not(:disabled)]:[filter:brightness(1.1)] [&.disabled]:![background-color:#94a3b8] disabled:![background-color:#94a3b8] [&.disabled]:![box-shadow:0_0.4rem_0_#64748b] disabled:![box-shadow:0_0.4rem_0_#64748b] [&.disabled]:![cursor:not-allowed] disabled:![cursor:not-allowed] [&.disabled]:![transform:translateY(0)] disabled:![transform:translateY(0)] [&.disabled]:![filter:none] disabled:![filter:none] [&.disabled]:![color:#e2e8f0] disabled:![color:#e2e8f0] btn-3d-green [--btn-color:#2ecc71] [--btn-shadow:#27ae60] text-[0.9333rem] px-8 py-2" onClick={() => { send('chanceShieldSelect', { tileId }); onClose(); }}>
                  🛡️ Gắn Khiên lên đây
                </button>
              )}

              {turnPhase === 'chance_give_city_select' && isMyTurn && isOwner && (
                <button className="font-inter cursor-pointer touch-manipulation disabled:opacity-50 disabled:cursor-not-allowed btn-3d [background-color:var(--btn-color,_#0ea5e9)] [color:var(--btn-text,_white)] [border:none] [border-radius:2rem] [padding:var(--btn-pad,_0.8rem_1.8667rem)] [font-size:var(--btn-size,_1.0667rem)] [font-weight:800] [cursor:pointer] [display:inline-flex] [justify-content:center] [align-items:center] [gap:0.5333rem] [box-shadow:0_0.4rem_0_var(--btn-shadow,_#0284c7)] [transition:transform_0.1s,_box-shadow_0.1s,_filter_0.1s] [text-transform:uppercase] [letter-spacing:0.5px] [&:active:not(.disabled):not(:disabled)]:[transform:translateY(0.4rem)] [&:active:not(.disabled):not(:disabled)]:[box-shadow:0_0px_0_var(--btn-shadow,_#0284c7)] [&:hover:not(.disabled):not(:disabled)]:[filter:brightness(1.1)] [&.disabled]:![background-color:#94a3b8] disabled:![background-color:#94a3b8] [&.disabled]:![box-shadow:0_0.4rem_0_#64748b] disabled:![box-shadow:0_0.4rem_0_#64748b] [&.disabled]:![cursor:not-allowed] disabled:![cursor:not-allowed] [&.disabled]:![transform:translateY(0)] disabled:![transform:translateY(0)] [&.disabled]:![filter:none] disabled:![filter:none] [&.disabled]:![color:#e2e8f0] disabled:![color:#e2e8f0] btn-3d-yellow [--btn-color:#f5c518] [--btn-shadow:#d97706] [--btn-text:#1a1a00] text-[0.9333rem] px-8 py-2" onClick={() => { send('chanceGiveCitySelect', { tileId }); onClose(); }}>
                  🎁 Chọn tặng đất này
                </button>
              )}

              {turnPhase === 'chance_festival_city_select' && isMyTurn && isOwner && (tile.tileType === 'property' || tile.tileType === 'port') && (
                <button className="font-inter cursor-pointer touch-manipulation disabled:opacity-50 disabled:cursor-not-allowed btn-3d [background-color:var(--btn-color,_#0ea5e9)] [color:var(--btn-text,_white)] [border:none] [border-radius:2rem] [padding:var(--btn-pad,_0.8rem_1.8667rem)] [font-size:var(--btn-size,_1.0667rem)] [font-weight:800] [cursor:pointer] [display:inline-flex] [justify-content:center] [align-items:center] [gap:0.5333rem] [box-shadow:0_0.4rem_0_var(--btn-shadow,_#0284c7)] [transition:transform_0.1s,_box-shadow_0.1s,_filter_0.1s] [text-transform:uppercase] [letter-spacing:0.5px] [&:active:not(.disabled):not(:disabled)]:[transform:translateY(0.4rem)] [&:active:not(.disabled):not(:disabled)]:[box-shadow:0_0px_0_var(--btn-shadow,_#0284c7)] [&:hover:not(.disabled):not(:disabled)]:[filter:brightness(1.1)] [&.disabled]:![background-color:#94a3b8] disabled:![background-color:#94a3b8] [&.disabled]:![box-shadow:0_0.4rem_0_#64748b] disabled:![box-shadow:0_0.4rem_0_#64748b] [&.disabled]:![cursor:not-allowed] disabled:![cursor:not-allowed] [&.disabled]:![transform:translateY(0)] disabled:![transform:translateY(0)] [&.disabled]:![filter:none] disabled:![filter:none] [&.disabled]:![color:#e2e8f0] disabled:![color:#e2e8f0] btn-3d-purple [--btn-color:#a855f7] [--btn-shadow:#7e22ce] text-[0.9333rem] px-8 py-2" onClick={() => { send('chanceFestivalSelect', { tileId }); onClose(); }}>
              ...
              {turnPhase === 'chance_attack_select' && isMyTurn && !isOwner && tile.ownerId !== '' && tile.houseCount < 4 && !(pendingChanceEffect === 'SABOTAGE' && tile.tileType === 'port') && (
                <button className="font-inter cursor-pointer touch-manipulation disabled:opacity-50 disabled:cursor-not-allowed btn-3d [background-color:var(--btn-color,_#0ea5e9)] [color:var(--btn-text,_white)] [border:none] [border-radius:2rem] [padding:var(--btn-pad,_0.8rem_1.8667rem)] [font-size:var(--btn-size,_1.0667rem)] [font-weight:800] [cursor:pointer] [display:inline-flex] [justify-content:center] [align-items:center] [gap:0.5333rem] [box-shadow:0_0.4rem_0_var(--btn-shadow,_#0284c7)] [transition:transform_0.1s,_box-shadow_0.1s,_filter_0.1s] [text-transform:uppercase] [letter-spacing:0.5px] [&:active:not(.disabled):not(:disabled)]:[transform:translateY(0.4rem)] [&:active:not(.disabled):not(:disabled)]:[box-shadow:0_0px_0_var(--btn-shadow,_#0284c7)] [&:hover:not(.disabled):not(:disabled)]:[filter:brightness(1.1)] [&.disabled]:![background-color:#94a3b8] disabled:![background-color:#94a3b8] [&.disabled]:![box-shadow:0_0.4rem_0_#64748b] disabled:![box-shadow:0_0.4rem_0_#64748b] [&.disabled]:![cursor:not-allowed] disabled:![cursor:not-allowed] [&.disabled]:![transform:translateY(0)] disabled:![transform:translateY(0)] [&.disabled]:![filter:none] disabled:![filter:none] [&.disabled]:![color:#e2e8f0] disabled:![color:#e2e8f0] btn-3d-red [--btn-color:#ef4444] [--btn-shadow:#b91c1c] text-[0.9333rem] px-8 py-2" onClick={() => { send('chanceAttackSelect', { tileId }); onClose(); }}>
                  ⚔️ Tấn công ô này
                </button>
              )}
            </div>
