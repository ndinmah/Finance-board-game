...
const CHANCE_CARDS_META: Record<string, { title: string; desc: string; color: 'green' | 'yellow' | 'red' }> = {
  ...
  'BLACKOUT': { title: 'Cúp Điện', desc: '1 khu đất đối thủ bị cúp điện, mất doanh thu cho đến khi đối thủ qua Xuất Phát 3 lần.', color: 'red' },
  ...
  'GOTO_START': { title: 'Về Vạch Xuất Phát', desc: 'Đi thẳng về Ô Xuất Phát và nhận thưởng 300k.', color: 'green' },
  'GOTO_ACTIVE_FESTIVAL': { title: 'Đi Xem Hội', desc: 'Đi thẳng đến khu đất đang tổ chức Lễ Hội (không mất tiền).', color: 'yellow' },
  'GOTO_FESTIVAL_CORNER': { title: 'Lạc Đường', desc: 'Đi thẳng đến Ô Lễ Hội.', color: 'yellow' },
  ...
  'BIRTHDAY': { title: 'Chúc Mừng Sinh Nhật', desc: 'Tất cả người chơi khác tặng bạn 25K.', color: 'green' },
